...
import { GameCoordinates } from "./types"
import { GAME_CONFIG, ABIS } from "./constants"

/**
 * Validates game coordinates
 */
export function validateCoordinates(coordinates: GameCoordinates): void {
 ...
 */
export function packCoordinates(coordinates: GameCoordinates): bigint {
  const { x, y } = coordinates
 ...
 */
export function encodeGameData(
  usdcAmount: bigint,
  userAddress: string,
